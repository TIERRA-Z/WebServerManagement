...
public static void createWindow() {
	JFrame f=new JFrame("Web Server Manager | Welcome!");

	//Setting Icon
	Image icon = Toolkit.getDefaultToolkit().getImage("WebIcon.png");  
	f.setIconImage(icon);  
	f.setLayout(null);   
	f.setSize(200,200);   
	f.setVisible(true); 
	...
	//No parent component so put null first
	JOptionPane.showMessageDialog(null, "Welcome to the Web Server Management System! Please enter your username and password to get started.");
	//creating instance of JFrame  
	final JTextField tf=new JTextField();
	tf.setBounds(50,50, 150,20);  
	JButton a = new JButton("Get Started");
	...
	JLabel l1=new JLabel("Username:");    
	 ...
	 //Checkbox Label to autofill crediteals later -l3
	   JLabel l3=new JLabel("Save this information"); 
	   l2.setBounds(20,75,80,30);
...
//JButton b=new JButton(new ImageIcon("D:\\icon.png"));  image on button
